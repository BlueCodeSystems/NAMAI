package org.smartregister.anc.library.reporting.coverage.fragment;
...
public class SetCsoDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.dialog_fragment_set_cso, container, false);
    ...
    private String getDefaultLocation() {
        List<String> rawDefaultLocation = LocationHelper.getInstance()
                .generateDefaultLocationHierarchy(LocationHelper.getInstance().getAllowedLevels());
