package org.smartregister.anc.library.reporting.dropuout.repository;
...
public class CohortRepository extends BaseRepository {
    ...
    public static final SimpleDateFormat DF_YYYYMM = new SimpleDateFormat("yyyy-MM", Locale.US);
