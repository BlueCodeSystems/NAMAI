package org.smartregister.anc.library.reporting.coverage.cso;
...
import org.smartregister.anc.library.reporting.BaseReportActivity;
import org.smartregister.anc.library.reporting.coverage.fragment.SetCsoDialogFragment;
...
//                startActivity(intent);
    ...
    private void updateCsoUnder1Population(boolean userAction) {
        ...
        csoValue.setOnClickListener(v -> SetCsoDialogFragment.launchDialog(AnnualCoverageReportCsoActivity.this, BaseReportActivity.DIALOG_TAG, getHolder()));
    ...
    protected <T> View generateView(final View view, final VaccineRepo.Vaccine vaccine, final List<T> indicators) {
        ...
        if (getHolder().getSize() == null) {
            ...
            if (AppUtils.isSameYear(getHolder().getDate(), new Date())) {
